...
public class modificar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("modificar.jsp");
         ...
         try{
            ...
            Career career = careerQuery.getCareerById(Integer.parseInt(idString),connection);
            request.setAttribute("carrera", career);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            q.updateCareer(Integer.parseInt(id),new Career(name), c);
